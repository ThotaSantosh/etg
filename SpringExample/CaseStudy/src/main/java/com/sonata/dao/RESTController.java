...
public class RESTController {
	...
	//to set notes
	@RequestMapping(value="/Task_ID/{Task_ID}/Notes/{Notes}",method = RequestMethod.GET,produces = {"application/json"})
	...
	//to set bookmarked
	@RequestMapping(value="/Task_ID/{Task_ID}/IsBookmarked/{IsBookmarked}",method = RequestMethod.GET,produces = {"application/json"})
